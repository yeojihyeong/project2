		...
		<article>
			...
			<section class="mb-5">
				...
				<p class="fs-5 mb-4">The universe is large and old, and the
					...
					reason to think that Earth would be unique in that regard. Whether
					of not the life became intelligent is a different question, and
